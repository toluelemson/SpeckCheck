...
const LinkItems = [
    ...
    {name: 'Specks', route: '/dashboard',  icon: FiUsers},
    // {name: 'Settings', route: '/dashboard/settings', icon: FiSettings},
];

export default function SidebarWithHeader({children} : any) {
...
const SidebarContent = ({onClose, ...rest}) => {
    return (
        <Box
            ...
            h="full"
            {...rest}>
            <Flex h="0" flexDirection="column" alignItems="center" mx="8" mb={75} mt={2} justifyContent="space-between">
