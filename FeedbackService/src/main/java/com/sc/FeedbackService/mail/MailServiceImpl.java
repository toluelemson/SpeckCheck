...
public class MailServiceImpl implements MailService{
    ...
    public void sendMail(String to, String subject, String content) {
        try{
            ...
            messageHelper.setFrom(senderEmail, "Speck Check");
            ...
            log.info("\n:::::::::::::::::::ERROR SENDING EMAIL:::::::::::::::::::\n");
            throw new FeedbackServiceException("Error Sending Email");
        }
    }

    @Override
    public String buildVerificationMail(String name, String link) {
    ...
    @Override
    public String buildResetPasswordMail(String name, String link) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                "\n" +
                "<span style=\"display:none;font-size:1px;color:#fff;max-height:0\"></span>\n" +
                "\n" +
                ...
                "        \n" +
                "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hi " + name + ",</p>" +
                "<p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">We received a request that you want to reset your password. Please click on the below link to reset your password: </p>" +
                ...
                "<a href=\"" + link + "\">Reset Password</a> </p></blockquote>\n Link will expire in 15 minutes. <p>If you did not request to change password, kindly ignore the request</p>" +
                "        \n" +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                "    </tr>\n" +
